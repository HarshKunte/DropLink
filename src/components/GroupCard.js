...
function GroupCard({item}) {
    return ( 
        <Link to={`/group/${item.id}`}  className='w-36 h-24 sm:w-40 sm:h-28 xl:w-60 xl:h-40 bg-bgDarkGreen rounded-2xl xl:rounded-3xl shadow-xl relative mr-3 mb-4 lg:mr-5'>
