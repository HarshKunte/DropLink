...
function GroupCard({item}) {
    return ( 
        <Link to={`/group/${item.name}`} state={{id:item.id, name:item.name}}  className='w-36 h-24 sm:w-40 sm:h-28 xl:w-60 xl:h-40 bg-bgLightGreen rounded-2xl shadow-xl relative mr-3 mb-4 lg:mr-5'>
